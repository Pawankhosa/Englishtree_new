    ...
    <form id="form1" runat="server">
        ...
        <div style=" width: 725px; height: 520px; padding: 2px; color: black; ">
            <div style="float: left; width: 235px;">
                <img src="images/insight-logo.png" width="189"/>
            </div>
            <div style="float: left; width: 490px;">
                <table style="width: 100%;">
                    <tr>
                        <td>
                            <h2 style="margin: 0px;text-transform:uppercase"><%=instname %></h2>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <p>Email:englishtreemoga@gmail.com</p>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div style="float: left; width: 100%; border-bottom: 1px solid">
                ...
                <div style="float: left; width: 398px;">
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td class="auto-style9">&nbsp;</td>
                            <td colspan="2">For EnglishTree</td>
                        </tr>
                        <tr>
