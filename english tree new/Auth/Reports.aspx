    ...
    <div class="grid" style="width: 1041px; margin-bottom: 30px">
        <asp:Panel ID="Panel2" runat="server" Visible="false">
            ...
            <asp:DropDownList ID="ddlfranc" runat="server"
                OnSelectedIndexChanged="ddlfranc_SelectedIndexChanged" AutoPostBack="true" CssClass="simple-input">
            </asp:DropDownList>
        </asp:Panel>
    </div>
    <div>
        ...
        &nbsp;&nbsp To:
        <asp:TextBox ID="txtToDate" CssClass="txtbox simple-input" runat="server"></asp:TextBox>
       ...
       Course Wise Fees: <asp:DropDownList ID="ddlCourseWiseFees" runat="server">
        ...
        &nbsp;&nbsp  
        <asp:Button ID="BtnLoadReport" CssClass="btn" runat="server"
        ...
        <asp:Panel ID="Panel1" runat="server">
                ...
                <div style="float: right; width: 200px">
                    <table>
                        ...
                        <tr>
                            <td>Total Income: &nbsp</td>
                            <td><%=totalIncome %></td>
                        </tr>
                        <tr>
                            <td>Profit/Loss: &nbsp</td>
                            <td><%=Total %></td>
                        </tr>
                    </table>
                </div>
        ...
        <br />
        <%--<asp:Button ID="btnPrint" CssClass="btn" runat="server" OnClick="printDiv('PrintDiv')" Text="Print" />--%>
        <asp:Button ID="btnPrint" CssClass="btn" runat="server" OnClientClick="return PrintPanel();" Text="Print" />
