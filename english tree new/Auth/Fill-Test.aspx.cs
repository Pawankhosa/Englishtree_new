...
public partial class Auth_Fill_Test : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] != null)
        {
            objsql.ExecuteNonQuery("update tblfill set name='" + txtname.Text + "',date='" + txtdate.Text + "',dob='" + txtdob.Text + "',passport='" + txtpassport.Text + "',doe='" + txtdoe.Text + "',choice1='" + txtd1.Text + "',module='" + CheckBoxList2.SelectedItem.Text + "',v1='" + txtv1.Text + "',v2='',mode='" + txtmode.Text + "',instname='" + txtinst.Text + "',status='" + rdomode.SelectedItem.Text + "',uname='"+txtuname.Text+"',pass='"+txtpass.Text+"' where id='" + Request.QueryString["id"] + "'");
        }
        else
        {
            objsql.ExecuteNonQuery("insert into tblfill(name,date,dob,passport,doe,choice1,choice2,choice3,module,v1,v2,v3,mode,instname,status,fid,uname,pass) values ('" + txtname.Text + "','"+txtdate.Text+"','" + txtdob.Text + "','" + txtpassport.Text + "','" + txtdoe.Text + "','" + txtd1.Text + "','','','" + CheckBoxList2.SelectedItem.Text + "','" + txtv1.Text + "','','','" + txtmode.Text + "','" + txtinst.Text + "','"+rdomode.SelectedItem.Text+"','"+fid+"','"+txtuname.Text+"','"+txtpass.Text+"')");
