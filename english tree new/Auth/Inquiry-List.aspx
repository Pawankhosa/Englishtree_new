...
<asp:Content ID="Content3" ContentPlaceHolderID="cpmain" Runat="Server">
    ...
    <asp:GridView ID="GridView1" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand" runat="server" AutoGenerateColumns="false" CssClass=" table table-bordered" OnRowDeleting="GridView1_RowDeleting">
        <Columns>
           ...
           <asp:TemplateField HeaderText="Course">
                <ItemTemplate>
                    <asp:Label runat="server" ID="lblname" Text= '<%#Eval("course") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
